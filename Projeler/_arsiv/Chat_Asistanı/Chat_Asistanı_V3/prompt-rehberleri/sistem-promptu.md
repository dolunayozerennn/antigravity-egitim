...
### 🛑 DİKKAT: AŞAĞIDAKİ BÖLÜMÜ KESİNLİKLE DEĞİŞTİRMEYİN 🛑
*(Sistemin düzgün çalışması için "Çıktı Formatı" kısmının birebir aynı kalması şarttır. Buradaki bir hata otomasyonu bozar.)*
