...
drive_service.upload_cover_to_drive("/tmp/antigravity_workaround/Dolunay_Reels_Kapak/outputs/video1_official_kapak.png", manual_cover_gen.DRIVE_URL, file_name="AI Tools Top 5 Kapak.png")
