...
## 🛠 Kullanım Amacı
Kullanıcının tek yapması gereken markayı ve fiyatı vermektir — ya da "e-postadan bak" demektir. Fatura üzerindeki *Description* kısmında doğrudan "`[Brand]` collaboration with @dolunay_ozeren" formatı uygulanır. İsimlendirme ise özel olarak `INVOICE_[Marka]_[GG-AA-YYYY].pdf` şeklinde yapılır.
...
// turbo
```bash
cd /Users/dolunayozeren/Desktop/Antigravity/_skills/fatura-olusturucu
...
// turbo
```bash
open -R "/Users/dolunayozeren/Desktop/Antigravity/_skills/fatura-olusturucu/uretilen-faturalar/INVOICE_${SAFE_BRAND}_${DATE}.pdf"
```

3. Ayrıca kullanıcıya dosyanın tıklanabilir linkini ver: `[INVOICE_Marka_GG-AA-YYYY.pdf](file:///Users/dolunayozeren/Desktop/Antigravity/_skills/fatura-olusturucu/uretilen-faturalar/INVOICE_Marka_GG-AA-YYYY.pdf)`
