...
> **Kaynak:** Buğra + Instagram İş Birliği projelerinden toplanmıştır.
...
| `{gonderici_adi}` | Gönderen kişinin adı | Buğra |
...
**Senaryo:** Etkinlik/festival için influencer'a ulaşma (Buğra tarzı)
...
Seninle birlikte çalışmak, etkinliğimizin doğru kitleye ulaşmasında büyük katkı sağlar diye düşünüyoruz.
...
{ekstra_bilgi} etkinliğimiz için bir iş birliği teklifi paylaşmak istiyoruz.
{deger_onerisi}
