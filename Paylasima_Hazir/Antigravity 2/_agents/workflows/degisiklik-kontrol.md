...
| Google Sheet tab ismi değişti | CRM, Notifier, Watchdog projeleri |
| Notion DB yapısı değişti | Tahsilat Takip, CRM, Reels Kapak projeleri |
...
## Adım 5.5 — i18n Kontrol (Web Sitesi Projeleri İçin)

> Bu adım **sadece** web sitesi projelerinde metin değişikliği yapıldığında uygulanır.
...
- README: ✅ Güncel
- i18n: ✅ 4 dil güncel (web sitesi projesi ise)
