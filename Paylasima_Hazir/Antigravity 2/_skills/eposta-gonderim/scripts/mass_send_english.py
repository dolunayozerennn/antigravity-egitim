...
# Paths
CSV_PATH = "./Projeler/Email_Responder/creator_outreach_tracking.csv"
SCRIPT_DIR = "./_skills"
TEMPLATE_PATH = "./Projeler/Email_Responder/outreach_template_v2.md"

if not os.path.exists(TEMPLATE_PATH):
    print(f"ERROR: Template not found at {TEMPLATE_PATH}")
    sys.exit(1)

TEMPLATE_SUBJECT = "Collaboration Inquiry - MARKA_ADI_BURAYA"
TEMPLATE_BODY = """Hi {Name},

Hope you are doing well!

I'm KULLANICI_ADI_BURAYA from the Influencer Marketing team at MARKA_ADI_BURAYA. I've been following your profile for a while and absolutely love the content you post. You have a great way of creating genuinely engaging and relatable content!

We would love to collaborate with you. We are looking for talented creators with your exact style to produce a short promotional video.
...
Influencer Marketing Team, MARKA_ADI_BURAYA"""
...
for i in range(2, len(rows)):
    ...
    cmd = [
        ...
        "--csv", "../Projeler/Email_Responder/creator_outreach_tracking.csv",
        "--row_id", str(i-1) 
    ]
