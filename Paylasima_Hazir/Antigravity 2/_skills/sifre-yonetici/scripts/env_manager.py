...
SERVICE_SIGNATURES = {
    ...
    "gmail_outreach": {
        "patterns": [r"GMAIL_OUTREACH", r"gmail.*outreach"],
        "env_vars": ["GMAIL_OUTREACH_CLIENT_ID", "GMAIL_OUTREACH_CLIENT_SECRET"],
    },
    "gmail_secondary": {
        "patterns": [r"GMAIL_SECONDARY", r"gmail.*secondary"],
        "env_vars": ["GMAIL_SECONDARY_CLIENT_ID", "GMAIL_SECONDARY_CLIENT_SECRET"],
    },
    "telegram": {
