...
- **Genel desen:** Bilinen kişisel e-posta adreslerini profil.md'den regex ile oluştur
- **Placeholder:** `EMAIL_ADRESI_BURAYA`

### Kişisel URL'ler
- **Desen:** `KULLANICI_ADI_BURAYA\.com`, `instagram\.com/KULLANICI_ADI_BURAYA` vb.
- **Placeholder:** `KISISEL_URL_BURAYA`

### Dosya Sistemi Yolları
- **Desen:** `/Users/KULLANICI_ADI_BURAYA/...`
