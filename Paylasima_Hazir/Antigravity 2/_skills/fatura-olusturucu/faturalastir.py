...
def generate_invoice(brand_name, company_name, company_email, company_address, amount, currency, output_dir, description_override=None):
    ...
    try:
        ...
        pdf.set_text_color(30, 30, 30)
        pdf.cell(100, 5, "KULLANICI_ADI_BURAYA", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
        pdf.set_font("Roboto", "", 10)
        pdf.set_text_color(80, 80, 80)
        ...
        pdf.cell(100, 5, "EMAIL_ADRESI_BURAYA", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
        pdf.cell(100, 5, "+90 555 555 55 55", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
        ...
        pdf.set_font("Roboto", "", 10)
        pdf.set_text_color(30, 30, 30)
        description = description_override if description_override else f"{brand_name} collaboration with @KULLANICI_ADI_BURAYA"
