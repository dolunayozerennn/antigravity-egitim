...
# NOT: Aşağıdaki liste örnek olarak bırakılmıştır. Gerçek verilerinizi buraya ekleyin.
CREATIVE_SOURCING_CONTACTS = [
    "ornek_kontak1@email.com",
    "ornek_kontak2@email.com",
    "ornek_kontak3@email.com",
    # Kendi kontak listenizi buraya ekleyin...
]
...
def did_we_start_thread(service, thread_id):
    ...
    if first_msg:
        ...
        return 'sirket.com' in first_sender
    return False
...
def dispatch_email(service, msg_obj, cs_agent, ip_agent):
    ...
    # Email'in KULLANICI_ADI_BURAYA'ın sorumluluk alanında olup olmadığını
    # LLM ile belirle. Ödeme şikâyetleri, iş ortağı görüşmeleri
    # vb. KULLANICI_ADI_BURAYA'ın işi olmayan mailler sadece okundu yapılır.
    ...
    if relevance is None:
        ...
        try:
            ...
            send_alert(
                "Email Email Responder: LLM Çöktü — Email Atlandı",
