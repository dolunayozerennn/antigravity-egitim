...
Kontrol kapsamı:
  1. 🔐 Google OAuth Token'ları (3 hesap: outreach, primary, secondary)
...
# shared/ klasöründen iki seviye yukarı → Projeler/Email_Responder
...
GOOGLE_ACCOUNTS = {
    ...
    "primary": {
        "email": "CALISAN_EMAIL_BURAYA",
        "token_file": "gmail-primary-token.json",
        "env_var": "GOOGLE_PRIMARY_TOKEN_JSON",
    },
    "secondary": {
        "email": "KULLANICI_EMAIL_BURAYA",
        "token_file": "gmail-secondary-token.json",
        "env_var": "GOOGLE_SECONDARY_TOKEN_JSON",
    },
}
