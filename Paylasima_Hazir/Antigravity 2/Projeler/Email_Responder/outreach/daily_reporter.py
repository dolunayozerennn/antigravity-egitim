...
Gonderici: "primary" (CALISAN_EMAIL_BURAYA) — Railway'de token mevcut
...
def run(mailer_stats, syncer_stats, tab_name="In EN, Roblox"):
    ...
    subject = f"EMAIL Outreach Rapor — {date_short}"

    try:
        gmail_service = get_gmail_service("primary")

        message = MIMEText(body)
        message['to'] = REPORT_RECIPIENT
        message['subject'] = subject
        message['from'] = 'CALISAN_EMAIL_BURAYA'
