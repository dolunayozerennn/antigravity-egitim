"""
MARKA_ADI_BURAYA Email Automation — Railway Scheduler
===============================================
...
Auth: Merkezi google_auth modülü kullanılır.
      ...
      Railway: GOOGLE_PRIMARY_TOKEN_JSON env variable
"""
...
_service_status = {
    "service": "marka_adi_buraya-email-automation",
...
def run_automation():
    ...
    try:
        ...
        # Bildirimi tetikle
        send_alert("Email Email Responder: Görev Çöktü", f"Email Responder (process_emails) çalışırken bir hata oluştu:\n\n{str(e)}\n\n{err_msg[:1000]}")
...
def run_data_fetch():
    ...
    try:
        ...
        if fetched == 0:
            ...
            send_alert(
                "Email Email Responder: Data Fetch — 0 Satır Aktarıldı",
        ...
        err_msg = traceback.format_exc()
        send_alert("Email Email Responder: Data Fetch Görevi Çöktü", f"Data Fetch çalışırken bir hata oluştu:\n\n{str(e)}\n\n{err_msg[:1000]}")
...
def run_outreach():
    ...
    try:
        ...
        err_msg = traceback.format_exc()
        send_alert("Email Email Responder: Outreach Görevi Çöktü", f"Outreach çalışırken bir hata oluştu:\n\n{str(e)}\n\n{err_msg[:1000]}")
...
def main():
    ...
    print("="*60)
    print("📧 MARKA_ADI_BURAYA Email Automation — Railway Cron")
