...
KULLANICI_ADI_BURAYA'ın gerçek yanıtları analiz edildiğinde, CS thread'lerde bile
...
- ŞİMDİLİK: KULLANICI_ADI_BURAYA'ın gerçek davranışını taklit ediyoruz
...
# ══════════════════════════════════════════════════════
CS_KNOWLEDGE = """
BUSINESS: MARKA_ADI_BURAYA Creative Sourcing — Creator iş birliği iletişimi.
...
- Style: Natural skit integrating MARKA_ADI_BURAYA
    ...
    def handle(self, ctx):
        ...
        if intent_result and intent_result.get("confidence", 0) >= 0.6:
            ...
            try:
                ...
                send_alert(
                    "Email Email Responder: LLM Intent Tespiti Başarısız (CS Agent)",
