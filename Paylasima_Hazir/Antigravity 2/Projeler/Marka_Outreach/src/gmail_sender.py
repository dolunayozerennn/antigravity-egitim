...
SENDER_EMAIL = os.environ.get("SENDER_EMAIL", "KULLANICI_EMAIL_BURAYA")

# Credential dosya yolları
CREDENTIALS_FILE = os.path.join(BASE_DIR, "..", "..", "_knowledge", "credentials", "oauth", "gmail-secondary-credentials.json")
TOKEN_FILE = os.path.join(BASE_DIR, "..", "..", "_knowledge", "credentials", "oauth", "gmail-secondary-token.json")
...
def authenticate():
    ...
    token_json_str = os.environ.get("GOOGLE_SECONDARY_TOKEN_JSON")
    if token_json_str:
        try:
            # Base64 decode
        ...
        if creds and creds.expired and creds.refresh_token:
            ...
            if not os.path.exists(CREDENTIALS_FILE):
                raise FileNotFoundError(
                    ...
                    "Railway'de: GOOGLE_SECONDARY_TOKEN_JSON env var ayarlayın."
                )
