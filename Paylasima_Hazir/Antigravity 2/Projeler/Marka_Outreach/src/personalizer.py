...
# ── KULLANICI_ADI_BURAYA profil bilgileri (template'lerde kullanılır) ────────────────────
KULLANICI_PROFILE = {
    "name": "KULLANICI_ADI_BURAYA",
    "instagram": "https://www.instagram.com/KULLANICI_ADI_BURAYA/",
    "tiktok": "https://www.tiktok.com/@SOSYAL_MEDYA_HANDLE",
    "youtube": "https://www.youtube.com/@SOSYAL_MEDYA_HANDLE/",
    "total_views": "100M+",
    "country": "Turkey",
...
🌐 WEBSITE_URL_BURAYA
📸 instagram.com/KULLANICI_ADI_BURAYA
▶️ youtube.com/@SOSYAL_MEDYA_HANDLE
🎵 tiktok.com/@SOSYAL_MEDYA_HANDLE
"""
...
<table cellpadding="0" cellspacing="0" style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #555555; border-top: 2px solid #7c3aed; padding-top: 12px; margin-top: 20px;">
  <tr>
    <td style="padding-bottom: 8px;">
      <strong style="font-size: 15px; color: #1a1a1a;">KULLANICI_ADI_BURAYA</strong><br>
  ...
  <tr>
    <td style="padding-bottom: 6px; font-size: 12px; color: #888;">
      📧 <a href="mailto:KULLANICI_EMAIL_BURAYA" style="color: #7c3aed; text-decoration: none;">KULLANICI_EMAIL_BURAYA</a>
      &nbsp;·&nbsp;
      🌐 <a href="https://WEBSITE_URL_BURAYA" style="color: #7c3aed; text-decoration: none;">WEBSITE_URL_BURAYA</a>
    </td>
  </tr>
  <tr>
    <td style="font-size: 12px;">
      <a href="https://instagram.com/KULLANICI_ADI_BURAYA" style="color: #E1306C; text-decoration: none; margin-right: 8px;">Instagram</a>
      <a href="https://youtube.com/@SOSYAL_MEDYA_HANDLE" style="color: #FF0000; text-decoration: none; margin-right: 8px;">YouTube</a>
      <a href="https://tiktok.com/@SOSYAL_MEDYA_HANDLE" style="color: #00f2ea; text-decoration: none; margin-right: 8px;">TikTok</a>
      <a href="https://linkedin.com/in/KULLANICI_ADI_BURAYA" style="color: #0077B5; text-decoration: none;">LinkedIn</a>
    </td>
  </tr>
</table>
"""
...
OUTREACH_SYSTEM_PROMPT = """You are writing a cold outreach email from KULLANICI_ADI_BURAYA, a content creator 
...
KULLANICI_ADI_BURAYA's profile:
...
- Instagram: @KULLANICI_ADI_BURAYA | TikTok: @SOSYAL_MEDYA_HANDLE | YouTube: @SOSYAL_MEDYA_HANDLE
...
def _append_signature(email_dict):
    ...
    if "body_text" in email_dict:
        # "Best, KULLANICI_ADI_BURAYA" gibi kapatışları temizle ve signature ekle
...
I'm KULLANICI_ADI_BURAYA, a content creator focused on AI, tech, and digital tools. My content has reached over 100 million organic views in Turkey.
...
<p>I'm <strong>KULLANICI_ADI_BURAYA</strong>, a content creator focused on AI, tech, and digital tools. My content has reached over <strong>100 million organic views</strong> in Turkey.</p>

<p>Recent results:</p>
<ul>
{"".join(f'<li><strong>{r["brand"]}</strong>: {r["views"]} views — <a href="{r["url"]}">View</a></li>' for r in KULLANICI_PROFILE["top_results"])}
</ul>
...
FOLLOWUP_SYSTEM_PROMPT = """You are writing a follow-up email for KULLANICI_ADI_BURAYA's brand collaboration outreach.
...
KULLANICI_ADI_BURAYA recently achieved: Syntx campaign successfully completed (first brand from this outreach pipeline!).
KULLANICI_ADI_BURAYA's latest views: Pixelcut reel now at 19.7M views.
