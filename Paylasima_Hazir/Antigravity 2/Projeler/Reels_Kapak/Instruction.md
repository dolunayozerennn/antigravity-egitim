...
# 🎬 KULLANICI_ADI_BURAYA Reels Kapak — Proje Talimatları

## Projenin Amacı
KULLANICI_ADI_BURAYA'ın Instagram Reels videoları için AI destekli kapak fotoğrafı (thumbnail) üretim sistemi.
...
run_autonomous_generation(
    local_person_image_path="ham-fotograflar/cutout.png",
