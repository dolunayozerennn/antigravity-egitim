...
- AI'ın referans kişiyi (KULLANICI_ADI_BURAYA) düzgün render etmesi kritik.
...
- Kapak fotoğrafında kullanıcının (KULLANICI_ADI_BURAYA) görselden **kolayca ayırt edilebilmesi** zorunludur.
...
- **Hata örneği**: Tripo 3D 2 — Kapak 1 ve 2'de KULLANICI_ADI_BURAYA yerine farklı kişi üretildi, Kapak 3'te doğru kişi üretildi.
