...
Production'da Service Account, lokalde credentials.json kullanır.
"""
import os
import sys
import json
...
class SheetsReader:
    ...
    def authenticate(self):
        ...
        if sa_info:
            ...
            # 2) Lokal credentials.json dosyası ile OAuth
            logger.info("🔑 Lokal credentials.json ile authentication yapılıyor...")
